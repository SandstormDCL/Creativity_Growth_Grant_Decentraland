...
function generateWrapDeep(ctx, fullProtoTypeName, fieldNames) {
    ...
    if ((0, types_1.isStructTypeName)(fullProtoTypeName)) {
        ...
        chunks.push((0, ts_poet_1.code) `export function wrap(object: {[key: string]: any} | undefined): Struct {
    ...
    if ((0, types_1.isAnyValueTypeName)(fullProtoTypeName)) {
        ...
        chunks.push((0, ts_poet_1.code) `export function wrap(value: any): Value {
      const result = {} as any;
      if (value === null) {
    ...
    if ((0, types_1.isListValueTypeName)(fullProtoTypeName)) {
        ...
        chunks.push((0, ts_poet_1.code) `export function wrap(array: ${maybeReadyOnly}Array<any> | undefined): ListValue {
    ...
    if ((0, types_1.isFieldMaskTypeName)(fullProtoTypeName)) {
        chunks.push((0, ts_poet_1.code) `export function wrap(paths: ${maybeReadonly(ctx.options)} string[]): FieldMask {
...
function generateUnwrapDeep(ctx, fullProtoTypeName, fieldNames) {
    ...
    if ((0, types_1.isStructTypeName)(fullProtoTypeName)) {
        if (ctx.options.useMapType) {
            chunks.push((0, ts_poet_1.code) `export function unwrap(message: Struct): {[key: string]: any} {
    ...
    if ((0, types_1.isAnyValueTypeName)(fullProtoTypeName)) {
        ...
        chunks.push((0, ts_poet_1.code) `export function unwrap(message: any): string | number | boolean | Object | null | Array<any> | undefined {
    ...
    if ((0, types_1.isListValueTypeName)(fullProtoTypeName)) {
        chunks.push((0, ts_poet_1.code) `export function unwrap(message: ${ctx.options.useReadonlyTypes ? "any" : "ListValue"}): Array<any> {
    ...
    if ((0, types_1.isFieldMaskTypeName)(fullProtoTypeName)) {
        chunks.push((0, ts_poet_1.code) `export function unwrap(message: ${ctx.options.useReadonlyTypes ? "any" : "FieldMask"}): string[] {
...
function generateUnwrapShallow(ctx, fullProtoTypeName, fieldNames) {
    ...
    if ((0, types_1.isAnyValueTypeName)(fullProtoTypeName)) {
        if (ctx.options.oneof === options_1.OneofOption.UNIONS) {
            chunks.push((0, ts_poet_1.code) `export function unwrap(message: Value): string | number | boolean | Object | null | Array<any> | undefined {
