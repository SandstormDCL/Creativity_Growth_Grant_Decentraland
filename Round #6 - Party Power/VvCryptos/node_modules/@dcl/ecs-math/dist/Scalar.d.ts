...
export declare namespace Scalar {
     ...
     */
    function pingPong(tx: number, length: number): number;
    /**
     ...
     */
    function smoothStep(from: number, to: number, tx: number): number;
    /**
     ...
     */
    function hermite(value1: number, tangent1: number, value2: number, tangent2: number, amount: number): number;
    /**
     ...
     */
    function rangeToPercent(num: number, min: number, max: number): number;
    /**
     ...
     * @returns the number
     */
    function percentToRange(percent: number, min: number, max: number): number;
    /**
