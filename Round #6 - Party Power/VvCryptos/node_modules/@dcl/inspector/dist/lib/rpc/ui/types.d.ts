...
export declare namespace UiRPC {
    const name = "UiRPC";
    enum Method {
    ...
    type Params = {
        ...
        [Method.TOGGLE_GIZMOS]: {
            enabled: boolean;
        };
        [Method.SELECT_ASSETS_TAB]: {
            tab: `${AssetsTab}`;
        };
        [Method.SELECT_SCENE_INSPECTOR_TAB]: {
            tab: `${SceneInspectorTab}`;
        };
        [Method.TOGGLE_SCENE_INSPECTOR_TAB]: {
            tab: `${SceneInspectorTab}`;
            enabled: boolean;
        };
        [Method.TOGGLE_GROUND_GRID]: {
            enabled: boolean;
        };
    };
    type Result = {
