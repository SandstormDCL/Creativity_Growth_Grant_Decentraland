...
function assert(path, test, r) {
    const res = path_to_regexp_1.match(path, { decode: decodeURIComponent })(test);
    expect_1.default(res.params).toEqual(r);
}
...
function handleRequest(url, handler) {
    // noop
}
